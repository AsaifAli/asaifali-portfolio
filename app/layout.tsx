...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body>
    ...
    <header className="site-header"><div className="shell nav-inner">
      ...
      <div className="nav-actions"><a href="https://github.com/AsaifAli" target="_blank" rel="noreferrer">GitHub ↗</a><a href="https://www.linkedin.com/in/sk-asaif-ali-134873243" target="_blank" rel="noreferrer">LinkedIn ↗</a></div>
      <MobileNav nav={nav} />
    </div></header>
    {children}
