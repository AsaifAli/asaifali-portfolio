...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="shell">
    ...
    <section className="detail-grid">
      ...
      <InteractiveDemo project={project.slug} description="Use your own provider key to open a short-lived inference session. The credential is never stored in Supabase or the portfolio UI." />
    </section>
